...
```
1.	Для работы вам понадобится база данных - создайте ее запустив XAMPP и phpMyAdmin.
Имя базы данных 'exam01', создайте тестовую таблицу 'test' с полями (id int, name varchar(100))
и добавьте 1 запись в таблицу (1, 'Билет 1')
